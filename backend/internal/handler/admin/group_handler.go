...
type CreateGroupRequest struct {
	...
	Platform         string             `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity grok composite external_openai_compatible volcengine_coding xunfei_coding"`
	...
	RequestPassthroughEnabled   bool                                      `json:"request_passthrough_enabled"`
	// 分组 RPM 上限（0 = 不限制）
...
func (h *GroupHandler) Create(c *gin.Context) {
	...
	group, err := h.adminService.CreateGroup(c.Request.Context(), &service.CreateGroupInput{
		...
		RequestPassthroughEnabled:       req.RequestPassthroughEnabled,
