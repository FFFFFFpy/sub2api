...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    ...
    case 'external_openai_compatible': return 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400'
    case 'volcengine_coding': return 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'
    case 'xunfei_coding': return 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    ...
    case 'external_openai_compatible': return 'text-indigo-700 dark:text-indigo-400'
    case 'volcengine_coding': return 'text-red-700 dark:text-red-400'
    case 'xunfei_coding': return 'text-cyan-700 dark:text-cyan-400'
    default: return ''
  }
}
